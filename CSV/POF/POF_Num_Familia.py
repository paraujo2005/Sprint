...
try:
    ...
    botao = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div/div[2]/div[2]/section/div[2]/table/tbody/tr[1]/td[3]/a')
    botao.click()
    ...
    botao = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div[1]/div[4]/div[2]/div/div[2]/div[3]/div/div[1]/div[1]/div/button[1]')
    botao.click()
    
    #Aumentar Decimos
    botao = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div[1]/div[4]/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div/div/div[2]/div/div/span/button[2]')
    botao.click()
    botao.click()

    #Selecionar Domicílio
    ...
    if arquivo_xlsx:
        ...
        minio_client.put_object(bucket_name, 'POF_Num_Familia.csv', csv_buffer, csv_buffer.getbuffer().nbytes)
        logging.info(f'O arquivo POF_Num_Familia.csv foi enviado com sucesso para o bucket {bucket_name} no MinIO!')
    else:
