...
try:
    ...
    botao = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div/div[2]/div[2]/section/div[4]/table/tbody/tr[1]/td[3]/a')
    botao.click()
    ...
    if arquivo_xlsx:
        ...
        minio_client.put_object(bucket_name, 'POF_Rendimento_Classe.csv', csv_buffer, csv_buffer.getbuffer().nbytes)
        logging.info(f'O arquivo POF_Rendimento_Classe.csv foi enviado com sucesso para o bucket {bucket_name} no MinIO!')
    else:
