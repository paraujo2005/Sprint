...
try:
    ...
    if arquivo_xlsx:
        ...
        minio_client.put_object(bucket_name, 'IDH_RM.csv', csv_buffer, csv_buffer.getbuffer().nbytes)
        logging.info(f'O arquivo IDH_RM.csv foi enviado com sucesso para o bucket {bucket_name} no MinIO!')
    else:
